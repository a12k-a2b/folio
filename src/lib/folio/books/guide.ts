...
<p>No menu first. No color picker. Daylight has no color; we would not insult the page with a highlighter rainbow even if it did. The three pens at the bottom — Book, Quote, Question — are the exception: pick one up, then tap. The tag is the color. The wash stays ink.</p>
...
<p>Tags are names, not colors. A person. A place. A book someone recommended. A question you were not ready to answer. They are also programmable highlighters: pick up Book, then tap a citation, and the work prints into the margin. Quote on a claim prints a skeptical check. Question, then a note like “Is there more recent work?”, sends the comment with the page around it. The wash stays ink. The tag is the color.</p>
